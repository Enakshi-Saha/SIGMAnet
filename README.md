...
- **Sample-specific Gaussian Graphical Model** (uses OSA by Chen, 2010 to estimate a prior penalized covariance matrix and uses this to estimate posterior inverse Gamma GGM, using Sherman Morrison for scalability.
