...
- **Sample-specific Gaussian Graphical Model** (uses OAS by Chen, 2010 to estimate a prior penalized covariance matrix and uses this to estimate posterior inverse Wishart GGM, using Sherman Morrison for scalability.
